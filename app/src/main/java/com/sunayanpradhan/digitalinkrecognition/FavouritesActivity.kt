...
class FavouritesActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val favouriteItems = StrokeManager.retrieveFavourites()

        // Convert the list of strings to a list of SearchHistoryItem objects
        val historyItems = favouriteItems.map { FavouriteItem(it, System.currentTimeMillis()) }

        // Initialize the adapter with the historyItems list
        adapter = FavouritesAdapter(historyItems.toMutableList())
